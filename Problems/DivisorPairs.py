...
# Examples
"""
(count_pairs_int(1, 50), 8)
(count_pairs_int(3, 100), 7)
(count_pairs_int(3, 200), 18)
(count_pairs_int(6, 350), 86)
(count_pairs_int(6, 1000), 214)
(count_pairs_int(7, 1500), 189)
(count_pairs_int(7, 2500), 309)
(count_pairs_int(7, 3000), 366)
(count_pairs_int(9, 4000), 487)
(count_pairs_int(9, 5000), 622)
(count_pairs_int(11, 5000), 567)
"""
...
print(count_pairs_int(6, 1000)) # expected: 214